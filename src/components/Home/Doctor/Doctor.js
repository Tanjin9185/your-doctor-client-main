        ...
        <div className='col-md-4 shadow rounded'>
            {
                doctor.name ?
                    <div className="p-3 m-2 text-center">
                        <img className='col-md-4 shadow bg-gray rounded' style={{ height: '250px', width: 'auto', objectFit: 'cover' }} src={`data:${image.contentType};base64,${image.img}`} className='img-fluid' alt="doctor" />
